...
class CombineOffsets(AbstractProcessStep):
  ...
  Takes the offsets that are generated in previous steps and combines them to generate a 'region of interest' (ROI)
  around the structure. The extra_horizontal and extra_vertical provide a buffer around the ROI to ensure the cropped
  region contains the entire ROI in case of imaging drift.
  """
