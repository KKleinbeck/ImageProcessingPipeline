...
class ApplyMask(AbstractProcessStep):
  ...
  Assumes that the mask stack has an equal or smaller depth than the input stack and that the mask frames
  ...
  """Stack containing a 0/1 mask that will be applied to the image stack. Must be of an equal or smaller depth than the
  image stack. Mask stacks with smaller depth than the input stack will be evenly stretched to fit the input stack's
  depth and subsequently interpolated."""
